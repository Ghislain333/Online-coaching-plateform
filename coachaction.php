...
<body>
    ...
    <section class="">
        <div class="courses_section">
            ...
            <div class="container courses_level-information">
                <?php
                $stmt = $con->prepare("SELECT * FROM users WHERE personal_coach = :user_name");
                ...
                <div class="single-course">
                    ...
                    <form action="addassignments.php?user_name=' . $student_name . '" method="post"> 
                      <button type="submit" name="learn" class="btn btn-primary">Send Assignment</button>
                    </form>
                    </div>
                ';
                }
    ...
    <footer class="footer">
        ...
        <div class="footer__copyright">
            <small>Copyright &copy; ghislainfk</small>
        </div>
    </footer>
    <!-- ********** End of footer *********** -->
